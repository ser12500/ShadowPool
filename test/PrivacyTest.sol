...
contract PrivacyTest is Test {
    ...
    function test_FeeTransparency() public {
        ...
        for (uint256 i = 0; i < amounts.length; i++) {
            ...
            assertEq(percentageFee, (amount * PERCENTAGE_FEE) / 1e18);
    ...
    function test_RealWorldPrivacyScenario() public {
        ...
        // After 10 deposits, we should have at least medium anonymity, so wait time should be 0 or 1800
        uint256 finalWaitTime = shadowPool.getOptimalWithdrawTime();
        assertTrue(finalWaitTime == 0 || finalWaitTime == 1800);
